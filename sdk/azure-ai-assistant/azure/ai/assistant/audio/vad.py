...
#
# NOTE: This code optionally uses the Silero VAD model, licensed separately under
# the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International
# (CC BY-NC-SA 4.0). If you download or redistribute that model, you must comply
# with its license terms, which can be found at:

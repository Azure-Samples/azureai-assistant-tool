...
class AsyncAssistantClientCallbacks:
    ...
    async def on_run_update(self, assistant_name, run_identifier, run_status, thread_name, is_first_message=False, message : TextMessage = None):
    ...
    async def on_run_failed(self, assistant_name, run_identifier, run_end_time, error_code, error_message, thread_name):
    ...
    async def on_run_cancelled(self, assistant_name, run_identifier, run_end_time, thread_name):
